...
VL_ATTR_COLD void VLed::trace(VerilatedVcdC* tfp, int levels, int options) {
    vl_fatal(__FILE__, __LINE__, __FILE__,"'VLed::trace()' called on model that was Verilated without --trace option");
}
